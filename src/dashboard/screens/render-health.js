...
const HEALTH_GROUPS = [
  ...
  {
    id: 'hubgaps', sev: 'notice', icon: '⌂', keys: ['hub-gap', 'area-moc-gap'],
    title: n => healthPlural(n, 'area') + ' not wired into your maps',
    desc: 'A folder or whole area here has no map-of-content (or its map is not linked from the parent), or an area has sub-maps but no top map tying them together. That leaves an area hard to find — and your AIs will not know to file into it, or will parent new notes to the wrong map.',
    count: n => healthPlural(n, 'area'),
    okTitle: 'every area is on the map', okDesc: 'Each folder has a map-of-content, every map is linked from its parent, and every area has a top map — new areas stay findable.', okCount: '0 areas',
  },
  {
